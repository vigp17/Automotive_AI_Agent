...
7. **Voice** - click the mic button, speak, click stop. In mock mode the transcript is
   always "What's my battery level?" and the spoken reply is a silent WAV; with Azure
   keys it's real STT/TTS.
